package com.example.LifeBalance.UI.Food
...
import com.example.LifeBalance.databinding.SearchmealBinding
...
class SearchMeal : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        onBackPressedDispatcher.addCallback(this) {
            startActivity(Intent(this@SearchMeal, Add_food::class.java))
            finish()
        }
    }
